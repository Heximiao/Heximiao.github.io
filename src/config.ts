	...
	banner: {
		...
		homeText: {
			...
			subtitle: [
				...
				"末日时在做什么？有没有空？可以来拯救吗？ ——STRONGER",
				"「風の歌声に　耳を澄ませ」 ——千趣喵",
				"为所欲为 但勿伤害 ——Aurora.Akie",
				"降落永不休止的雨滴  ——群睡眠小助手|˄·͈༝·͈˄₎.｡oO",
				"我已经燃烧殆尽，只剩下雪白的灰  ——因幡爱瑠",
			],
			typewriter: {
	...
	links: [
		...
		},
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/Heximiao",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/479384437",
					external: true,
...
export const pioConfig: import("./types/config").PioConfig = {
	enable: false, // 启用看板娘
	models: ["/pio/models/poi/model.json"], // 默认模型路径
